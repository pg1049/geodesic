...
IGL_INLINE void igl::opengl::ViewerData::del_last_points()
{
    points.conservativeResize(points.rows()-1,6);
}
...
IGL_INLINE void igl::opengl::ViewerData::del_last_edges()
{
    lines.conservativeResize(lines.rows()-1,9);
}
