...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref "488242fa2b1f98a9c5bd1441297fb4a99a6a9ae4"
  WORKING_DIRECTORY "G:/geodesic/cmake/../external/predicates"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'G:/geodesic/cmake/../external/predicates'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'G:/geodesic/cmake/../external/predicates'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
